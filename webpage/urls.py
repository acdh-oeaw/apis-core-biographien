...
urlpatterns = [
    ...
    path(r"", views.GenericWebpageView.as_view(), name="start"),
    path(r"accounts/login/", views.user_login, name="user_login"),
    path(r"logout/", views.user_logout, name="user_logout"),
    path(r"set_user_settings/", views.set_user_settings, name="set_user_settings"),
    path(r"project-info/", views.project_info, name="project_info"),
    re_path(
        r"^(?P<template>[\w-]+)/$",
